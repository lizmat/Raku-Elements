...
#- Element ---------------------------------------------------------------------
class Raku::Element:ver<0.0.5>:auth<zef:lizmat> {
    has str $.name;
    has     @.alternates;
    has     @.tags;
    has str $.tagline;
...
#- Group -----------------------------------------------------------------------
class Raku::Group:ver<0.0.5>:auth<zef:lizmat> {
    has str $.name;
    has str $.description;
    has     @.elements;
...
#- Tag -------------------------------------------------------------------------
class Raku::Tag:ver<0.0.5>:auth<zef:lizmat> {
    has str $.name;
    has str $.description;
    has     @.elements;
...
#- Elements --------------------------------------------------------------------
class Raku::Elements:ver<0.0.5>:auth<zef:lizmat> {
    has %.elements;
    has %.groups;
    has %.tags;
